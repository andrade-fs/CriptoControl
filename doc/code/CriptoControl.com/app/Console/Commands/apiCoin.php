...
class apiCoin extends Command
{
    ...
    public function handle()
    {
      ...
      /**
        ...
        $datosMonedas = file_get_contents("public/apiCripto.json");
...
// dd("hola");
        ...
        $file = 'public/apiCripto.json';
        file_put_contents($file, $response);
        $file2 = 'public/monedas.json';
        ...
        $texto = "[".date("Y-m-d H:i:s")."]: Tarea cron SUCCESS";
